...
/*   Updated: 2025/02/10 16:09:40 by rduro-pe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	main_menu_content(void)
{
	...
	ft_printf("\n" HCYN "▖▞▙▗" DEF "\t\t\t\t\t\t " HCYN "▖▞▙▗" DEF);
	ft_printf("\n" HCYN "▖▞▙▗\t" DEF);
	ft_printf(GRN "› OUR " YEL "BRAND NEW" GRN " HANDHELD: " BLK CYNB
		" EAGN " DEF);
	ft_printf("\t " HCYN "▖▞▙▗" DEF);
	ft_printf("\n" HCYN "▖▞▙▗" DEF "\t\t\t\t\t\t " HCYN "▖▞▙▗" DEF);
	ft_printf("\n" HCYN "▖▞▙▗\t" DEF);
...
{
	ft_printf("\n\n\n\n" HCYN "▚▗▛▘\t" DEF);
	ft_printf(GRN "› you're a " CYN "flying robot" GRN " sent to " DEF);
	ft_printf("\t " HCYN "▖▞▙▗" DEF);
	ft_printf("\n" HCYN "▚▛▘▗\t" DEF);
	ft_printf(GRN "  collect valuable " YEL "SDCARDS\t" DEF);
	ft_printf("\t " HCYN "▖▞▙▗" DEF);
	ft_printf("\n\n\n" HCYN "▚▗▛▘\t" DEF);
